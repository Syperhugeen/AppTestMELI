...
const ItemLista = (props) => {
	...
	return (
		<div className="p-2 col-12 mb-2 d-flex flex-row align-items-center  item-lista-contenedor">
			...
			<div className="w-100 d-flex felx-row align-items-center">
				<div className="w-75 align-self-start py-3">
